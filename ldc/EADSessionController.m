...
#define EAD_INPUT_BUFFER_SIZE 128
    ...
    while ([[_session inputStream] hasBytesAvailable])
    {
		...
		stringFromData = [NSString stringWithFormat:@"%.*s", [_readData length], [_readData bytes]];
    }

	[[NSNotificationCenter defaultCenter] postNotificationName:EADSessionDataReceivedNotification object:self userInfo:@{@"string": stringFromData}];
}
